...
'            '#End Region ' #GetPageCountForSelection
        ...
        Private Sub checkEdit8_CheckedChanged(ByVal sender As Object, ByVal e As EventArgs) Handles checkEdit8.CheckedChanged
            customDrawHeader = If(checkEdit8.Checked, True, False)
            richEditControl1.Refresh()
        End Sub
